...
def _print_setup_walkthrough(home: Path) -> None:
    ...
    text = dedent(
        ...
        - bot_account_ids: author IDs to force-classify as bots (operator override
          for transports whose is_bot heuristic misses them; complements the
          per-transport signal — OR'd with event.is_bot)
