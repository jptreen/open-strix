...
| Skill | What it does |
|-------|-------------|
| **bluesky-poller** | Bluesky notification monitor with follow-gate trust tiers and cursor-based dedup |
| **github-poller** | GitHub repo monitor for issues, PRs, comments, and reviews with self-filtering |
